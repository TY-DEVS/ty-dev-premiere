      ...
      <div className="relative mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        {t.process.steps.map((s, i) => (
          <motion.div
            ...
            className="relative"
          >
            <div className="relative w-16 h-16 rounded-2xl bg-surface border border-brand/30 flex items-center justify-center mb-6 shadow-[0_0_30px_oklch(0.6_0.22_265/0.15)]">
              <span className="font-mono text-brand text-lg font-bold">
                0{i + 1}
              </span>
            </div>
